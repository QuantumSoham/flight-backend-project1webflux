...
public class FlightController {
    ...
    // Admin: add airline inventory (airline + flights) - simplified
    @PostMapping("/airline")
...
//    public Mono<Flight> addInventory(@Valid @RequestBody Flight flight) {
//        // create flight document (controller can call repository directly or through service; keep simple)
//        return Mono.just(flight); // placeholder: actual save should be via repository bean; integrate if desired.
//    }

    @PostMapping("/airline/inventory/{airlineCode}")
    public Mono<ResponseEntity<Object>> addInventory(
